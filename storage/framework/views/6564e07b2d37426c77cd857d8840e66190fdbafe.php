        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <input type="button" class="btn btn-primary" Value="New Category" style="width: 100%"  data-toggle="modal" data-target="#myModal">
                </div>
            </div>
...
<?php echo $__env->make('layouts.adminpagelayouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Year (Prepare for work)\Laravel\Assignment_Sokim\assignment-web-semester-ll\resources\views/adminpage/blogcategory.blade.php ENDPATH**/ ?>